...
<footer>
  <p id="footnote-zipfile">[1] Rickroll!!! Src code (zip) is only available on college's server (<a href="./MonteCosmoLocalization.zip">download</a>).<a href="#footnote-zipfile-ref">&#8629;</a></p>
</footer>
